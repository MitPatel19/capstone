...
import { ArrowLeft, Check, Clock3, MapPin, Navigation, Star, Users, X } from 'lucide-react'
import { api } from '../api'
                  ...
                  <div key={jr.id} className="rounded-2xl border border-slate-300 p-4">
                    ...
                    <div className="mt-3 grid grid-cols-2 gap-3">
                      <button
                        ...
                        disabled={jr.driver_decision === true || jr.status === 'accepted' || jr.status === 'rejected'}
                      >
                        Accept
                      </button>
                      <button
                        ...
                        disabled={jr.driver_decision === false || jr.status === 'accepted' || jr.status === 'rejected'}
                      >
                        Reject
                      </button>
                    </div>
